...
public class DangZhuZhiHuoDongGuanLiActivity extends BaseActivity {
    ...
    @BindView(R.id.end_time_pop)
    LinearLayout end_time_pop;
    @BindView(R.id.start_time_pop)
    LinearLayout start_time_pop;
    ...
    protected int setLayout() {
        return R.layout.activity_dzzhdgl;
    }
    ...
    protected void setView() {
        ...
        end_time_pop.setOnClickListener(this);
        start_time_pop.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.start_time_pop:
                setTimd();
                break;
            case R.id.end_time_pop:
                setTimd();
                break;
    ...
    private void toSend() {
        ...
        try {
            base64File = "data:image/jpeg;base64,"+Utils.encodeBase64File(compressPath);
        } catch (Exception e) {
            e.printStackTrace();
        }

        Log.e("TAG","base64File:"+base64File.toString().trim());
        ...
        try {
            ...
            jsonObject.put("type", "14401");
            jsonObject.put("startTime", "2018-08-20 14:19:35");
            jsonObject.put("endTime", "2018-08-20 14:19:35");
            jsonObject.put("supposedNum", 1);
            jsonObject.put("realNum", 1);
            jsonObject.put("site", "地址");
            jsonObject.put("content", "content");
            jsonObject.put("solve", "solve");
            jsonObject.put("note", "note");
            jsonObject.put("picContent", base64File == null? "":base64File.toString().trim());
        } catch (JSONException e) {
            e.printStackTrace();
        }

        mMyOkhttp.post()
                .url(ApiConstants.ZhuZhiShengHuoGuanLiAddApi)
...
/*		Intent intent = new Intent();
                ...
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(DangZhuZhiHuoDongGuanLiActivity.this).themeStyle(themeId).openExternalPreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(DangZhuZhiHuoDongGuanLiActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(DangZhuZhiHuoDongGuanLiActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            PictureSelector.create(DangZhuZhiHuoDongGuanLiActivity.this)
