...
import customer.tcrj.com.djproject.sy.infoactivity.SpstudyActivity;
...
public class SpFregment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener {
    ...
    private SplistviewAdapter detailAdapter;
    ...
    protected void setView() {
        ...
        mRecyclerView.setAdapter(detailAdapter = new SplistviewAdapter(beanList,  mContext,id,mMyOkhttp,userId));
