...
import customer.tcrj.com.djproject.adpater.msgAdapter;
...
public class mymsgActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener {
    ...
    private msgAdapter detailAdapter;
    private List<msgInfo.DataBean.ContentBean> beanList;
    ...
    protected void setView() {
        ...
        mRecyclerView.setAdapter(detailAdapter = new msgAdapter(beanList, this));
    ...
    private void getData(final int num) {
        ...
        mMyOkhttp.post()
                .url(ApiConstants.msgApi)
                .jsonParams(jsonObject.toString())
                .enqueue(new GsonResponseHandler<msgInfo>() {
                    @Override
                    public void onFailure(int statusCode, String error_msg) {

                        Toast.makeText(mymsgActivity.this, error_msg, Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(mymsgActivity.this, response.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    //上拉加载更多数据
    private void loadMoreData(msgInfo response,boolean isError) {
...
//                Toast.makeText(this, getResources().getString(R.string.data_nomore), Toast.LENGTH_SHORT).show();
                ...
                List<msgInfo.DataBean.ContentBean> content = response.getData().getContent();
                pageNum++;
    ...
    //下拉刷新
    private void loadData(List<msgInfo.DataBean.ContentBean> response,boolean isError) {
...
//                Toast.makeText(flfgListActivity.this, getResources().getString(R.string.data_failed), Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        msgInfo.DataBean.ContentBean response = (msgInfo.DataBean.ContentBean) adapter.getItem(position);
        Bundle bundle = new Bundle();
        bundle.putSerializable("msgInfo",response);
        toClass(this,DialogmsgActivity.class,bundle);
//        toClass(this, DialogmsgActivity.class);
    }
}
