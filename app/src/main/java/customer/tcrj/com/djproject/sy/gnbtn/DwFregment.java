...
public class DwFregment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener {
...
//  public TextView title_tv;
    ...
    private DwlistviewAdapter detailAdapter;
    ...
    protected void setView() {
        ...
        mRecyclerView.setAdapter(detailAdapter = new DwlistviewAdapter(beanList, mContext));
