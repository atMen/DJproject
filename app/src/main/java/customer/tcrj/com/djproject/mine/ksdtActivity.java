...
public class ksdtActivity extends BaseActivity {
        ...
        Object insertObj = new Object(){
            ...
            public void T(final String t){//js调用java Toast方法
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(ksdtActivity.this, t, Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            public String getUserID(){//js调用java Toast方法
                Toast.makeText(ksdtActivity.this, loginInfo.getData().getId(), Toast.LENGTH_SHORT).show();
