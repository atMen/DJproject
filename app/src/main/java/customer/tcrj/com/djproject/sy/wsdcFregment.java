...
import customer.tcrj.com.djproject.mine.ksActivity;
import customer.tcrj.com.djproject.mine.wjdcListActivity;
...
public class wsdcFregment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener, View.OnClickListener {
    ...
    protected void setView() {
        ...
        mRecyclerView.setAdapter(detailAdapter = new wjdclistAdapter(beanList, mContext));
...
//      bundle.putSerializable("teacherinfo",response);
        Log.e("TAG","h5:"+ApiConstants.h5hdjlApi+"?voteId="+response.getId());
