...
import customer.tcrj.com.djproject.adpater.DkAdapter;
import customer.tcrj.com.djproject.adpater.DkglAdapter;
...
public class DkglActivity extends BaseActivity implements FreshNewsAdapter.OnItemClickListener {
    ...
    private List<dkInfo.DataBean.ContentBean> beanList;
    ...
    protected void setView() {
        ...
        mRecyclerView.setAdapter(detailAdapter = new DkAdapter(beanList, DkglActivity.this));
    ...
    JSONObject jsonObject = new JSONObject();
        ...
        mMyOkhttp.post()
                .url(ApiConstants.dklistApi)
                .jsonParams(jsonObject.toString())
                .enqueue(new GsonResponseHandler<dkInfo>() {
        @Override
        public void onFailure(int statusCode, String error_msg) {

            Toast.makeText(DkglActivity.this, error_msg, Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(mContext, response.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    //上拉加载更多数据
    private void loadMoreData(dkInfo response,boolean isError) {
...
//                Toast.makeText(mContext, getResources().getString(R.string.data_nomore), Toast.LENGTH_SHORT).show();
                ...
                List<dkInfo.DataBean.ContentBean> content = response.getData().getContent();
    ...
    //下拉刷新
    private void loadData(List<dkInfo.DataBean.ContentBean> response,boolean isError) {
...
//                Toast.makeText(flfgListActivity.this, getResources().getString(R.string.data_failed), Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        dkInfo.DataBean.ContentBean response = (dkInfo.DataBean.ContentBean) adapter.getItem(position);
