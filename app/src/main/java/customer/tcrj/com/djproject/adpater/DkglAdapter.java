 ...
 * date: 2017/9/27 .
 */
public class DkglAdapter extends BaseQuickAdapter<qyListInfo.DataBean, BaseViewHolder>{
    private Context mContext;

    public DkglAdapter(@Nullable List<qyListInfo.DataBean> data, Context context) {
